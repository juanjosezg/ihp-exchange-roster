...
facility_filters = ['URGENT CARE', 'SKILLED NURSING FACILITY', 'LABS AND RADIOLOGY', 'SPECIALIST', 'ANCILLARY SERVICES PROVIDER', 'MID LEVEL PROVIDER FOR SPECIALIST', 'HOSPITAL']
